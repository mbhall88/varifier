...
vcf_lines.append(
    [
        ...
        161,
        ".",
        "".join(ref_seq[160:163]),
        "ACGTACGGGTGGTGTGTTTGAAAGATAG",
        ".",
        "PASS",
        ".",
        "GT:EXPECT",
...
vcf_lines.append(
    ["ref", 300, ".", complex_ref, complex_alt, ".", "PASS", ".", "GT:EXPECT", "1/1:TP"]
)
vcf_lines.append(
    [
        "ref",
...
truth_seq[249] = "C"
vcf_lines.append(
    ["ref", 250, ".", "G", "C", ".", "FILTER_X", ".", "GT:EXPECT", "1/1:TP"]
)
vcf_lines.append(
    [
        "ref",
...
vcf_lines.append(
    [
        ...
        ".",
        "GT:EXPECT",
        "1/1:VFR_FILTER_REF_STRING_MISMATCH",
    ]
)
vcf_lines.append(
    ["ref", 250, ".", "G", "C", ".", "PASS", ".", "EXPECT", "VFR_FILTER_NO_GT"]
)
vcf_lines.append(
    ["ref", 250, ".", "G", ".", ".", "PASS", ".", "GT:EXPECT", "1/1:VFR_FILTER_NO_ALTS"]
)
vcf_lines.append(
    [
        "ref",
